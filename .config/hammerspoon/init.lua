...
hs.timer
    .new(0, function()
        ...
        UnitedHotkey.ActionMap["meteor_window_move_by_grid"] = {
            "Move Window...",
            function()
        ...
        UnitedHotkey.ActionMap["meteor_window_toggle_maxsize"] = {
            nil,
            function()
                local wind = hs.window.focusedWindow() or hs.window.frontmostWindow()
                if wind == nil then
